...
const Terms = () => {
  return (
    ...
    <br />
        ...
        2.2. We reserve the right at any time to modify or discontinue the Service or any part or content thereof without notice at any time.
        <br />

        2.3. Prices for our products are subject to change without notice. We shall not be liable to you or to any third-party for any modification, price change, suspension, or discontinuance of the Service.
        <br />
        <br />
